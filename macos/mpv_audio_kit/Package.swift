...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libmpv",
            url: "https://github.com/ales-drnz/mpv_audio_kit/releases/download/libmpv-r9/libmpv_macos.xcframework.zip",
            checksum: "38fd9bb25568c85e547bd7f19bf4907a96cc5ea7b5fc14f5b85c8ef70ad986de"),
        // mpvkit:remote:end
    ]
)
