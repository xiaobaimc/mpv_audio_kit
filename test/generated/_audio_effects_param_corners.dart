...
const List<ParamCorner> kFilterParamCorners = [
  ...
  (
    ...
    bundle: const AudioEffects(
        arnndn:
            const ArnndnSettings(enabled: true, mix: ArnndnSettings.mixDefault))
  ),
  (
    filter: 'arnndn',
    label: 'mix=mixMax',
    bundle: const AudioEffects(
        arnndn: const ArnndnSettings(enabled: true, mix: ArnndnSettings.mixMax))
  ),
  (
    filter: 'asoftclip',
  ...
  (
    ...
    bundle: const AudioEffects(
        headphone: const HeadphoneSettings(
            enabled: true, lfe: HeadphoneSettings.lfeDefault))
  ),
  (
    filter: 'headphone',
    label: 'lfe=lfeMax',
  ...
  (
    ...
    bundle: const AudioEffects(
        headphone: const HeadphoneSettings(
            enabled: true, size: HeadphoneSettings.sizeMin))
  ),
  (
    filter: 'headphone',
