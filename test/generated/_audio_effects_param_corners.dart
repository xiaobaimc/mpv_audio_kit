...
const List<ParamCorner> kFilterParamCorners = [
  ...
  (
    ...
    bundle: const AudioEffects(
        adeclick:
            const AdeclickSettings(enabled: true),)
  ),
  (
    filter: 'adeclick',
    label: 'a=aMax',
  ...
  (
    ...
    bundle: const AudioEffects(
        adeclip:
            const AdeclipSettings(enabled: true),)
  ),
  (
    filter: 'adeclip',
    label: 'a=aMax',
  ...
  (
    ...
    label: 'ns=nsDefault',
    bundle: const AudioEffects(
        afade: const AfadeSettings(enabled: true),)
  ),
  (
    filter: 'afade',
    label: 'ns=nsMax',
  ...
  (
    ...
    bundle: const AudioEffects(
        afade:
            const AfadeSettings(enabled: true),)
  ),
  (
    filter: 'afftdn',
    label: 'ad=adMin',
  ...
  (
    ...
    bundle: const AudioEffects(
        afftdn:
            const AfftdnSettings(enabled: true),)
  ),
  (
    filter: 'afftdn',
    label: 'ad=adMax',
  ...
  (
    ...
    bundle: const AudioEffects(
        afwtdn:
            const AfwtdnSettings(enabled: true),)
  ),
  (
    filter: 'afwtdn',
  ...
  (
    ...
    bundle: const AudioEffects(
        agate:
            const AgateSettings(enabled: true),)
  ),
  (
    filter: 'agate',
    label: 'knee=kneeMax',
  ...
  (
    ...
    bundle: const AudioEffects(
        aiir:
            const AiirSettings(enabled: true),)
  ),
  (
    filter: 'aiir',
  ...
  (
    ...
    bundle: const AudioEffects(
        aiir: const AiirSettings(enabled: true),)
  ),
  (
    filter: 'aiir',
    label: 'dry=dryMax',
  ...
  (
    ...
    bundle: const AudioEffects(
        allpass:
            const AllpassSettings(enabled: true),)
  ),
  (
    filter: 'allpass',
    label: 'f=fMax',
  ...
  (
    ...
    label: 'm=mMax',
    bundle: const AudioEffects(
        allpass: const AllpassSettings(enabled: true),)
  ),
  (
    filter: 'allpass',
    label: 'mix=mixMin',
  ...
  (
    ...
    label: 'm=mDefault',
    bundle: const AudioEffects(
        anlmdn: const AnlmdnSettings(enabled: true),)
  ),
  (
    filter: 'anlmdn',
    label: 'm=mMax',
  ...
  (
    ...
    bundle: const AudioEffects(
        apad:
            const ApadSettings(enabled: true),)
  ),
  (
    filter: 'apad',
  ...
  (
    ...
    label: 'mix=mixMin',
    bundle: const AudioEffects(
        arnndn: const ArnndnSettings(enabled: true, mix: ArnndnSettings.mixMin),)
  ),
  (
    filter: 'arnndn',
    label: 'mix=mixDefault',
    bundle: const AudioEffects(
        arnndn:
            const ArnndnSettings(enabled: true),)
  ),
  (
    filter: 'arnndn',
    label: 'mix=mixMax',
    bundle: const AudioEffects(
        arnndn: const ArnndnSettings(enabled: true),)
  ),
  (
    filter: 'asoftclip',
  ...
  (
    ...
    bundle: const AudioEffects(
        atilt:
            const AtiltSettings(enabled: true),)
  ),
  (
    filter: 'atilt',
    label: 'freq=freqMax',
  ...
  (
    ...
    bundle: const AudioEffects(
        bandpass:
            const BandpassSettings(enabled: true),)
  ),
  (
    filter: 'bandpass',
    label: 'b=bDefault',
  ...
  (
    ...
    bundle: const AudioEffects(
        bandreject:
            const BandrejectSettings(enabled: true),)
  ),
  (
    filter: 'bandreject',
    label: 'b=bDefault',
  ...
  (
    ...
    label: 'b=bMin',
    bundle: const AudioEffects(
        bass: const BassSettings(enabled: true),)
  ),
  (
    filter: 'bass',
    label: 'b=bDefault',
  ...
  (
    ...
    bundle: const AudioEffects(
        bass:
            const BassSettings(enabled: true),)
  ),
  (
    filter: 'bass',
  ...
  (
    ...
    bundle: const AudioEffects(
        biquad:
            const BiquadSettings(enabled: true),)
  ),
  (
    filter: 'biquad',
    label: 'a0=a0Max',
  ...
  (
    ...
    label: 'b=bMin',
    bundle: const AudioEffects(
        biquad: const BiquadSettings(enabled: true),)
  ),
  (
    filter: 'biquad',
    label: 'b=bDefault',
  ...
  (
    ...
    bundle: const AudioEffects(
        chorus: const ChorusSettings(
            enabled: true, in_gain: ChorusSettings.in_gainMin,),)
  ),
  (
    filter: 'chorus',
    label: 'in_gain=in_gainDefault',
  ...
  (
    ...
    bundle: const AudioEffects(
        chorus: const ChorusSettings(
            enabled: true, in_gain: ChorusSettings.in_gainMax,),)
  ),
  (
    filter: 'chorus',
    label: 'out_gain=out_gainMin',
    bundle: const AudioEffects(
        chorus: const ChorusSettings(
            enabled: true, out_gain: ChorusSettings.out_gainMin,),)
  ),
  (
    filter: 'chorus',
    label: 'out_gain=out_gainDefault',
  ...
  (
    ...
    bundle: const AudioEffects(
        chorus: const ChorusSettings(
            enabled: true, out_gain: ChorusSettings.out_gainMax,),)
  ),
  (
    filter: 'compand',
    label: 'delay=delayMin',
  ...
  (
    ...
    bundle: const AudioEffects(
        deesser:
            const DeesserSettings(enabled: true),)
  ),
  (
    filter: 'deesser',
    label: 'f=fMax',
  ...
  (
    ...
    bundle: const AudioEffects(
        dynaudnorm:
            const DynaudnormSettings(enabled: true),)
  ),
  (
    filter: 'dynaudnorm',
    label: 'o=oDefault',
  ...
  (
    ...
    bundle: const AudioEffects(
        equalizer:
            const EqualizerSettings(enabled: true),)
  ),
  (
    filter: 'equalizer',
    label: 'b=bDefault',
  ...
  (
    ...
    label: 'gain=gainMin',
    bundle: const AudioEffects(
        headphone: const HeadphoneSettings(
            enabled: true, gain: HeadphoneSettings.gainMin,),)
  ),
  (
    filter: 'headphone',
    label: 'gain=gainDefault',
  ...
  (
    ...
    bundle: const AudioEffects(
        headphone: const HeadphoneSettings(
            enabled: true, gain: HeadphoneSettings.gainMax,),)
  ),
  (
    filter: 'headphone',
    label: 'lfe=lfeMin',
    bundle: const AudioEffects(
        headphone: const HeadphoneSettings(
            enabled: true, lfe: HeadphoneSettings.lfeMin,),)
  ),
  (
    filter: 'headphone',
    label: 'lfe=lfeDefault',
    bundle: const AudioEffects(
        headphone: const HeadphoneSettings(
            enabled: true,),)
  ),
  (
    ...
    bundle: const AudioEffects(
        headphone: const HeadphoneSettings(
            enabled: true, lfe: HeadphoneSettings.lfeMax,),)
  ),
  (
    filter: 'headphone',
    label: 'size=sizeMin',
  ...
  (
    ...
    bundle: const AudioEffects(
        headphone: const HeadphoneSettings(
            enabled: true, size: HeadphoneSettings.sizeMax,),)
  ),
  (
    filter: 'highpass',
    label: 'b=bMin',
    bundle: const AudioEffects(
        highpass:
            const HighpassSettings(enabled: true),)
  ),
  (
    filter: 'highpass',
    label: 'b=bDefault',
  ...
  (
    ...
    bundle: const AudioEffects(
        highshelf:
            const HighshelfSettings(enabled: true),)
  ),
  (
    filter: 'highshelf',
    label: 'b=bDefault',
  ...
  (
    ...
    bundle: const AudioEffects(
        loudnorm:
            const LoudnormSettings(enabled: true),)
  ),
  (
    filter: 'loudnorm',
    label: 'I=IMax',
  ...
  (
    ...
    label: 'b=bMin',
    bundle: const AudioEffects(
        lowpass: const LowpassSettings(enabled: true),)
  ),
  (
    filter: 'lowpass',
    label: 'b=bDefault',
    bundle: const AudioEffects(
        lowpass:
            const LowpassSettings(enabled: true),)
  ),
  (
    filter: 'lowpass',
    label: 'b=bMax',
  ...
  (
    ...
    bundle: const AudioEffects(
        lowshelf:
            const LowshelfSettings(enabled: true),)
  ),
  (
    filter: 'lowshelf',
    label: 'b=bDefault',
  ...
  (
    ...
    bundle: const AudioEffects(
        speechnorm:
            const SpeechnormSettings(enabled: true),)
  ),
  (
    filter: 'speechnorm',
    label: 'm=mDefault',
  ...
  (
    ...
    bundle: const AudioEffects(
        tiltshelf:
            const TiltshelfSettings(enabled: true),)
  ),
  (
    filter: 'tiltshelf',
    label: 'b=bDefault',
  ...
  (
    ...
    label: 'b=bMin',
    bundle: const AudioEffects(
        treble: const TrebleSettings(enabled: true),)
  ),
  (
    filter: 'treble',
    label: 'b=bDefault',
  ...
  (
    ...
    bundle: const AudioEffects(
        treble:
            const TrebleSettings(enabled: true),)
  ),
  (
    filter: 'treble',
    label: 'mix=mixMax',
  ...
  (
    ...
    bundle: const AudioEffects(
        tremolo:
            const TremoloSettings(enabled: true),)
  ),
  (
    filter: 'tremolo',
    label: 'd=dMax',
  ...
  (
    ...
    bundle: const AudioEffects(
        vibrato:
            const VibratoSettings(enabled: true),)
  ),
  (
    filter: 'vibrato',
    label: 'd=dMax',
